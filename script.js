...
document.getElementById("siBtn").addEventListener("click", function () {
  ...
  document.getElementById("messageContainer").innerHTML =
    "Em hông ngờ tới luôn đó, iu anh lắm luônnn:3";
...
document.getElementById("noBtn").addEventListener("click", function () {
  switch (noButtonState) {
    case 0:
      ...
      document.getElementById("noBtn").innerHTML = "Cho em cơ hội đii mầ";
    ...
    case 2:
      document.getElementById("noBtn").innerHTML = "iuu anh hết mực nữaaaa";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
      document.getElementById("sadGifContainer").style.display = "none";
      document.getElementById("sadGifContainer2").style.display = "none";
    ...
    case 4:
      document.getElementById("noBtn").innerHTML =
        "Thật sự anh không đồng ý saooo?";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 5:
      document.getElementById("noBtn").innerHTML =
        "Anh muốn bỏ rơi cô gái dangiu này ư";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
      ...
      break;
    case 6:
      document.getElementById("noBtn").innerHTML = "Đừng em xin anh đóooooo";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 7:
      ...
      break;
    case 8:
      document.getElementById("noBtn").innerHTML = "Em sẽ bùnnn đóooooo";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 10:
      document.getElementById("noBtn").innerHTML =
        "hãy chấp nhận tình iuu của emm nhóo";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 11:
      document.getElementById("noBtn").innerHTML =
        "Em thật sự rất và rất iuu anh đó";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 12:
      document.getElementById("noBtn").innerHTML =
        "Đừng bỏ rơi cô gái đáng thương này mà";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 13:
      document.getElementById("noBtn").innerHTML = "Anh đồng ý nhóooooo";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 16:
      document.getElementById("noBtn").innerHTML = "Điiiiii mà Anh";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
